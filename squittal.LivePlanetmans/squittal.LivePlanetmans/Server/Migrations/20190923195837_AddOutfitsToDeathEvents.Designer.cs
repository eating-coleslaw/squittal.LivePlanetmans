...
namespace squittal.LivePlanetmans.Server.Migrations
{
    ...
    [Migration("20190923195837_AddOutfitsToDeathEvents")]
    partial class AddOutfitsToDeathEvents
    {
            ...
            modelBuilder.Entity("squittal.LivePlanetmans.Shared.Models.Death", b =>
                {
                    ...
                    b.HasOne("squittal.LivePlanetmans.Shared.Models.Outfit", "AttackerOutfit")
                        .WithMany()
                    ...
                    b.HasOne("squittal.LivePlanetmans.Shared.Models.Outfit", "CharacterOutfit")
                        .WithMany()
